...
public class ChangePwdActivity extends XActivity<PChangePsw> {
    ...
    public void onViewClicked() {
        ...
        getP().changePassword(AppUser.getInstance().getUserId(), changepwdOldpwdEt.getNonSeparatorText(), changepwdNewpwdEt.getNonSeparatorText(), changepwdNewpwdsEt.getNonSeparatorText());
    }
