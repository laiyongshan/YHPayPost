...
import com.yzf.Cpaypos.present.PFindPassword;
...
public class FindPasswordActivity extends XActivity<PFindPassword> {
    ...
    @OnClick({R.id.findpwd_code_bt, R.id.findpwd_confirm_bt, R.id.findpwd_call_tv})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.findpwd_code_bt:
                getvDelegate().showLoading();
                getP().getCode(findpwdPhoneEt.getNonSeparatorText());
                break;
            case R.id.findpwd_confirm_bt:
                getvDelegate().showLoading();
                getP().findpassword(findpwdPhoneEt.getNonSeparatorText(), findpwdPwdEt.getNonSeparatorText(), findpwdCodeEt.getNonSeparatorText());
                break;
            case R.id.findpwd_call_tv:
                break;
        }
    }
