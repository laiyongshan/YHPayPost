 ...
 * FixDescription：
 */
public class Level3Fragment extends XFragment {
    ...
    public void setAData() {
        if (feeListBean.size() > 0) {
            for (GetMerchLevelResults.DataBean.FeeListBean bean : feeListBean) {
                if (bean.getMerchLevel().equals("3") && bean.getServiceId().equals("04"))//微信
                {
                ...
                if (bean.getMerchLevel().equals("3") && bean.getServiceId().equals("02"))//境内快捷
                {
                ...
                if (bean.getMerchLevel().equals("3") && bean.getServiceId().equals("03"))//境外快捷
                {
