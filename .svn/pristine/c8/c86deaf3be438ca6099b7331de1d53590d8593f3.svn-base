...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.yzf.Cpaypos.R.styleable.MultipleStatusView, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(com.yzf.Cpaypos.R.styleable.MultipleStatusView_emptyView, com.yzf.Cpaypos.R.layout.empty_view);
        mErrorViewResId = a.getResourceId(com.yzf.Cpaypos.R.styleable.MultipleStatusView_errorView, com.yzf.Cpaypos.R.layout.error_view);
        mLoadingViewResId = a.getResourceId(com.yzf.Cpaypos.R.styleable.MultipleStatusView_loadingView, com.yzf.Cpaypos.R.layout.loading_view);
        mNoNetworkViewResId = a.getResourceId(com.yzf.Cpaypos.R.styleable.MultipleStatusView_noNetworkView, com.yzf.Cpaypos.R.layout.no_network_view);
        mContentViewResId = a.getResourceId(com.yzf.Cpaypos.R.styleable.MultipleStatusView_contentView, NULL_RESOURCE_ID);
        a.recycle();
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mEmptyView) {
            mEmptyView = view;
            View emptyRetryView = mEmptyView.findViewById(com.yzf.Cpaypos.R.id.empty_retry_view);
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams, String msg) {
        ...
        if (null == mEmptyView) {
            mEmptyView = view;
            View emptyRetryView = mEmptyView.findViewById(com.yzf.Cpaypos.R.id.empty_retry_view);
            TextView textView = (TextView) mEmptyView.findViewById(com.yzf.Cpaypos.R.id.empty_view_tv);
    ...
    public final void showError(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mErrorView) {
            mErrorView = view;
            View errorRetryView = mErrorView.findViewById(com.yzf.Cpaypos.R.id.error_retry_view);
            TextView textView = (TextView) mErrorView.findViewById(com.yzf.Cpaypos.R.id.error_view_tv);
    ...
    public final void showNoNetwork(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mNoNetworkView) {
            mNoNetworkView = view;
            View noNetworkRetryView = mNoNetworkView.findViewById(com.yzf.Cpaypos.R.id.no_network_retry_view);
